...
```
A CLI tool to show the total number of dependencies that any package has on the npm registry.

Usage: lsdeps <PACKAGE>

Arguments:
  <PACKAGE>  The npm package for which to view dependencies
