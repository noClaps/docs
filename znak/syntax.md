...
The language can be omitted if the code block should be rendered as plaintext. You can see the [languages supported by Shiki](https://shiki.style/languages) to see if the language you want to use can be highlighted properly.
